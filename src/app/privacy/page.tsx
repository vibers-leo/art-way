...
export const metadata: Metadata = {
  title: "개인정보처리방침 | 아트웨이 갤러리",
  description: "아트웨이 갤러리 개인정보처리방침",
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        <section className="mb-10">
          <p className="text-base text-gray-700 leading-relaxed">
            아트웨이 협동조합(이하 &quot;회사&quot;)은 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및 관계 법령이 정한 바를 준수하여, 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. 이에 「개인정보 보호법」 제30조에 따라 정보주체에게 개인정보 처리에 관한 절차 및 기준을 안내하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
          </p>
        </section>
          ...
          <div className="space-y-3 text-base text-gray-700 leading-relaxed">
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>아트웨이 갤러리 전시 및 아카이브 서비스 제공</li>
                <li>전시 정보 및 작품 안내</li>
                <li>고객 상담 및 문의 응대</li>
              </ul>
            </div>
